    ...
    <nav class="navbar navbar-default">
        <div class="container">
            <div class="col-xs-5 col-sm-2 col-md-2 col-lg-2">
                <div class="logo"><a href="<?=self::HOST?>" class="navbar-brand"><span class="sh">Ш</span><span class="plus">++</span></a></div>
            </div>
            <div class="col-xs-12 col-sm-7 col-md-8 col-lg-8">
                <div class="main-menu">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <form class="navbar-form navbar-right" method="POST" action="<?=self::HOST?>/search" required="required" autocomplete="off">
                            <div class="form-group">
                                <input id="search" type="text" placeholder="Найти книгу" class="form-control" name="search">
                                <div class="loader"><img src="<?=self::HOST?>/books-page_files/loading.gif"></div>
